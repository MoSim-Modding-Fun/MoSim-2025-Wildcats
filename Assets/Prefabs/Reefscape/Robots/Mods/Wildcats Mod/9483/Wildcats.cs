...
namespace Prefabs.Reefscape.Robots.Mods.Wildcats._9483
{
    public class Lynk: ReefscapeRobotBase
    {
        ...
        [SerializeField] private WildcatsSetpoint stow;
        [SerializeField] private WildcatsSetpoint intake;
        [SerializeField] private WildcatsSetpoint l1;
        [SerializeField] private WildcatsSetpoint l1Place;
        [SerializeField] private WildcatsSetpoint l2;
        [SerializeField] private WildcatsSetpoint l3;
        [SerializeField] private WildcatsSetpoint l4;
        [SerializeField] private WildcatsSetpoint l4Place;
        
        [Header("algae Setpoints")]
        [SerializeField] private WildcatsSetpoint lowAlgae;
        [SerializeField] private WildcatsSetpoint highAlgae;
        [SerializeField] private WildcatsSetpoint bargePrep;
        [SerializeField] private WildcatsSetpoint bargePlace;
